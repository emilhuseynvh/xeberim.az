...
function AdminSidebar() {
    ...
    return (
        <>
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen  transition-transform ${flag ? 'translate-x-0' : '-translate-x-full'}`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/admin/home" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                                ...
                                <span className="ms-3">Create News</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="delete-news" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Delete News</span>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="register" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Users Register</span>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="/admin" onClick={() => handleClick()} className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                        ...
                        <li>
                            <Link to="/" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Go to Website</span>
                            </Link>
                        </li>
                    </ul>
                </div>
            ...
            <div className='w-full flex justify-end pr-5'>
                <button onClick={() => setFlag(!flag)} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2  mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 ">
